...
import com.byteflow.learnffmpeg.util.SystemUtils;
...
public class NumericKeyboard extends View {
    ...
    private void initData(Context context) {
        ...
        //添加每一列的纵坐标
        ys[0] = 40 + first_y - 15;
        ys[1] = 40 + first_y + 180 - 15;
        ys[2] = 40 + first_y + 360 - 15;
        ys[3] = 40 + first_y + 540 - 15;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 绘制第2排4,5,6
        canvas.drawText("4", first_x, 40 + first_y + 180, paint);
        canvas.drawText("5", first_x * 2, 40 + first_y + 180, paint);
        canvas.drawText("6", first_x * 3, 40 + first_y + 180, paint);
        // 绘制第3排7,8,9
        canvas.drawText("7", first_x, 40 + first_y + 360, paint);
        canvas.drawText("8", first_x * 2, 40 + first_y + 360, paint);
        canvas.drawText("9", first_x * 3, 40 + first_y + 360, paint);
        // 绘制第4排0
        canvas.drawText("0", first_x * 2, 40 + first_y + 540, paint);
        //为每一个数字绘制一个圆
        ...
        //依次绘制第2排的圆
        canvas.drawCircle(first_x + 10, 40 + first_y + 180 - 15, 70, paint);
        canvas.drawCircle(first_x * 2 + 10, 40 + first_y + 180 - 15, 70, paint);
        canvas.drawCircle(first_x * 3 + 10, 40 + first_y + 180 - 15, 70, paint);
        //依次绘制第3排的圆
        canvas.drawCircle(first_x + 10, 40 + first_y + 360 - 15, 70, paint);
        canvas.drawCircle(first_x * 2 + 10, 40 + first_y + 360 - 15, 70, paint);
        canvas.drawCircle(first_x * 3 + 10, 40 + first_y + 360 - 15, 70, paint);
        //绘制最后一个圆
        canvas.drawCircle(first_x * 2 + 10, 40 + first_y + 540 - 15, 70, paint);
